...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http , @Qualifier("accessTokenJwtDecoder")JwtDecoder jwtDecoder) throws Exception {
        ...
        /*
            disable CSRF token for post data from client to server
         */
        http.csrf(AbstractHttpConfigurer::disable);


        // security mechanism
        // explain: once we set spring security use JWT . it will required bean JwtDecoder for decode JWT Token
